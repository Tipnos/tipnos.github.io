...
- JSON with [Message Pack](https://msgpack.org/) (or equivalent) and [JSON schema](https://json-schema.org/).
...
impl AvroSchema for Comment {
    fn get_schema() -> Schema {
        Schema::parse_str(include_str!("../avro/standalone-schemas/Comment.avsc"))
...
>The whole rust code is available [in github](https://github.com/Tipnos/tipnos.github.io/tutorials/binaries-encoding/avro)
...
Everything is versionned in [a mono repo](https://github.com/apache/avro). The specification is implemented in [mainstream programming languages](https://github.com/apache/avro/tree/main/lang).

To conclude, IMO the available resources about Avro are too limited for an easy adoption in a company. Some efforts should be made on adoption by:
